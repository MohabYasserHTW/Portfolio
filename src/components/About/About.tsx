    ...
    <Section sectionTitle={"About"}>
      ...
      <div className="about_hero">
        ...
        >
          ...
          <p>
            Over the past year, I've had the privilege to contribute my
            expertise to a range of projects, each of which has deepened my
            problem-solving abilities and expanded my technical prowess. From
            architecting robust databases to crafting intuitive user interfaces,
            I've been fortunate to collaborate with talented teams to bring
